...
@router.get("/configuration",
    ...
    description="Retrieves all light control configuration parameters including brightness, auto mode settings, and operational thresholds",
    tags=["Configuration"]
)
...
@router.put("/configuration/{key}",
    ...
    description="Updates a single light control configuration parameter by key. Use this to adjust brightness levels, enable/disable auto mode, or modify operational thresholds",
    tags=["Configuration"]
)
